using AbilityTool.apoc_api_serverrunner.Services;
using AbilityTool.Client.Commands;
using AbilityTool.Client.Messages;
using AbilityTool.Client.Models;
using AbilityTool.Client.Services;
using AbilityTool.Dtos;
...
namespace AbilityTool.Client.ViewModels
{
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        {
            WindowTitle = "WAR-Apoc AbilityTool";
            Name = "MainViewModel";
